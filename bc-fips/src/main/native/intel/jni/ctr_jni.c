...
//
//
#include "org_bouncycastle_crypto_fips_AESNativeCTR.h"
#include "../ctr/ctr.h"
...
/*
 * Class:     org_bouncycastle_crypto_fips_AESNativeCTR
 * Method:    makeNative
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_makeNative
        (JNIEnv *e, jclass cl) {
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_getPosition
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_getMultiBlockSize
        (JNIEnv *env, jclass cl, jlong ref) {
#ifdef BC_AVX
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_skip
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_seekTo
 ...
 * Signature: (J[B[B)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_init
 ...
 * Signature: (JB)B
 */
JNIEXPORT jbyte JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_returnByte
 ...
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_processBytes
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_reset
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCTR_dispose
        (JNIEnv *, jclass, jlong ref) {
