...
#include "org_bouncycastle_crypto_fips_NativeEntropySource.h"
#include "stdint.h"
...
/*
 * Class:     org_bouncycastle_crypto_fips_NativeEntropySource
 * Method:    isPredictionResistant
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_org_bouncycastle_crypto_fips_NativeEntropySource_isPredictionResistant
        (JNIEnv *env, jobject) {
    return JNI_TRUE;
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_NativeEntropySource_modulus
        (JNIEnv *env, jobject) {
    return RAND_MOD;
}
 ...
 * Signature: ([BZ)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_NativeEntropySource_seedBuffer
