#include "org_bouncycastle_crypto_fips_AESNativeCBC.h"
 ...
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_process
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_getMultiBlockSize
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_getBlockSize
        (JNIEnv *e, jclass c, jlong) {
 ...
 * Signature: (IZ)J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_makeNative
 ...
 * Signature: (J[B[B)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_init
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_dispose
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCBC_reset
        (JNIEnv *env, jclass cl, jlong ref) {
    cbc_ctx *ctx = (cbc_ctx *) ((void *) ref);
    cbc_reset(ctx);
}