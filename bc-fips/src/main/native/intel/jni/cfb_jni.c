#include "org_bouncycastle_crypto_fips_AESNativeCFB.h"
 ...
 * Signature: (JB)B
 */
JNIEXPORT jbyte JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_processByte
 ...
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_processBytes
 ...
 * Signature: (IZ)J
 */
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_makeNative
 ...
 * Signature: (J[B[B)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_init
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_dispose
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_reset
        (JNIEnv *e, jclass cl, jlong ref) {
    cfb_ctx *ctx = (cfb_ctx *) ((void *) ref);
    cfb_reset(ctx);
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_bouncycastle_crypto_fips_AESNativeCFB_getNativeMultiBlockSize
