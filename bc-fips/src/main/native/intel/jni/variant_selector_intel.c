...
#include <stdbool.h>
#include "org_bouncycastle_crypto_fips_VariantSelector.h"
 ...
 */
JNIEXPORT jstring JNICALL Java_org_bouncycastle_crypto_fips_VariantSelector_getBestVariantName
        (JNIEnv *env, jclass) {
 ...
 * Signature: ()[Ljava/lang/String;
 */
 JNIEXPORT jobjectArray JNICALL Java_org_bouncycastle_crypto_fips_VariantSelector_getFeatureMatrix
        (JNIEnv *env, jclass) {
