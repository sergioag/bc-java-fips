...
{
    protected JcaJceKeyHelper bcHelper;
    ...
    X509CertificateImpl(JcaJceKeyHelper bcHelper, org.bouncycastle.asn1.x509.Certificate c,
    ...
    public PublicKey getPublicKey()
    {
        try
        {
            return bcHelper.convertPublicKey(c.getSubjectPublicKeyInfo());
        }
        catch (IOException e)
        {
