...
class PrincipalUtils
{
    ...
    {
        if (certificate instanceof X509CertificateImpl)
        {
            return notNull(((X509CertificateImpl)certificate).getIssuerX500Name());
        }
    ...
    static X500Name getSubjectPrincipal(X509Certificate certificate)
    {
        if (certificate instanceof X509CertificateImpl)
        {
            return notNull(((X509CertificateImpl)certificate).getSubjectX500Name());
        }
