...
{
    static final Algorithm drbgAlg = new Algorithm()
    {
    ...
    static final byte[] drbgPersonalize = Strings.toByteArray(ECPoint.class.getName());
    ...
    public ECPoint normalize()
    {
        ...
        default:
        {
             ...
             */
            SecureRandom r = FipsDRBG.fetchBasicDRBG(drbgAlg, FipsDRBG.SHA256, drbgPersonalize);
