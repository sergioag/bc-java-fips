...
import org.bouncycastle.crypto.internal.MaxBytesExceededException;
    ...
    implements SkippingStreamCipher
{
        ...
        CipherParameters params)
    {
        ...
        {
            counter = ((ParametersWithCounter)params).getCounter();
            params = ((ParametersWithCounter)params).getParameters();
        }
