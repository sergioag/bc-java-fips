...
public final class X931PRNG
{
    ...
    public static class Builder
    {
        ...
        public GeneralSecureRandom build(SymmetricKey key, boolean predictionResistant)
        {
            ...
            return new GeneralSecureRandom(random, getAlgorithmName(engine, keySizeInBits), new ContinuousTestingPseudoRNG(new X931PseudoRandom(new X931RNG(engine, dtv, entropySource)), null), entropySource, predictionResistant);
        }
