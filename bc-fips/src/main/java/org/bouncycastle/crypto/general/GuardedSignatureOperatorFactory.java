    ...
    implements SignatureOperatorFactory<T>
{
    ...
    public final OutputValidator<T> createValidator(AsymmetricPublicKey key, T parameters, final byte[] signature)
        throws InvalidSignatureException
    {
        ...
        return doCreateValidator(key, parameters, signature);
    }
    ...
    protected abstract OutputValidator<T> doCreateValidator(AsymmetricPublicKey key, T parameter, byte[] signature)
        throws InvalidSignatureException;
}
