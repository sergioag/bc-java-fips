...
public final class SecureHash
{
    ...
    public static final class Algorithm
    {
        ...
        public static final GeneralDigestAlgorithm GOST3411_2012_256 = new GeneralDigestAlgorithm("GOST3411-2012-256", Variations.GOST3411_2012_256);
        public static final GeneralDigestAlgorithm GOST3411_2012_256_HMAC = new GeneralDigestAlgorithm("GOST3411-2012-256/HMAC", Variations.GOST3411_2012_256_HMAC);
        public static final GeneralDigestAlgorithm GOST3411_2012_512 = new GeneralDigestAlgorithm("GOST3411-2012-512", Variations.GOST3411_2012_512);
        public static final GeneralDigestAlgorithm GOST3411_2012_512_HMAC = new GeneralDigestAlgorithm("GOST3411-2012-512/HMAC", Variations.GOST3411_2012_512_HMAC);
    }
    ...
    static
    {
        ...
        defaultMacSize.put(Algorithm.GOST3411_2012_256_HMAC, 256);
        defaultMacSize.put(Algorithm.GOST3411_2012_512_HMAC, 512);
    }
    ...
    public static final Parameters GOST3411_2012_256 = new Parameters(Algorithm.GOST3411_2012_256);
    public static final AuthParameters GOST3411_2012_256_HMAC = new AuthParameters(Algorithm.GOST3411_2012_256_HMAC);
    public static final Parameters GOST3411_2012_512 = new Parameters(Algorithm.GOST3411_2012_512);
    public static final AuthParameters GOST3411_2012_512_HMAC = new AuthParameters(Algorithm.GOST3411_2012_512_HMAC);
    ...
    private static Mac getMac(GeneralAlgorithm algorithm)
    {
        ...
        case WHIRLPOOL_HMAC:
            ...
            break;
        case GOST3411_2012_256_HMAC:
            mac = SelfTestExecutor.validate(algorithm, new HMac(new GOST3411_2012_256Digest()), new HMacKatTest(Hex.decode("cac825e894961594eeef8fd4f27a1cd0bda54c175160f12ef22fc20c042efa7c")));
            break;
        case GOST3411_2012_512_HMAC:
            mac = SelfTestExecutor.validate(algorithm, new HMac(new GOST3411_2012_512Digest()), new HMacKatTest(Hex.decode("f384729546493f501a2180e69e9265eef6102b25bd0017b0e4e410efd89b862df24ab76b3421cbe9caecb086f9d81c3625ee16e98aeeb2cf37977e458754a7f7")));
            break;
        default:
        ...
        case GOST3411_2012_256:
            return new DigestCloner<Digest>()
            {
                public Digest makeDigest(Digest original)
                {
                    if (original != null)
                    {
                        return new GOST3411_2012_256Digest((GOST3411_2012_256Digest)original);
                    }

                    return SelfTestExecutor.validate(algorithm, new GOST3411_2012_256Digest(), new DigestKatTest(Hex.decode("4e2919cf137ed41ec4fb6270c61826cc4fffb660341e0af3688cd0626d23b481")));
                }
            };
        case GOST3411_2012_512:
            return new DigestCloner<Digest>()
            {
                public Digest makeDigest(Digest original)
                {
                    if (original != null)
                    {
                        return new GOST3411_2012_512Digest((GOST3411_2012_512Digest)original);
                    }

                    return SelfTestExecutor.validate(algorithm, new GOST3411_2012_512Digest(), new DigestKatTest(Hex.decode("28156e28317da7c98f4fe2bed6b542d0dab85bb224445fcedaf75d46e26d7eb8d5997f3e0915dd6b7f0aab08d9c8beb0d8c64bae2ab8b3c8c6bc53b3bf0db728")));
                }
            };
        default:
