...
import org.bouncycastle.crypto.internal.modes.gcm.GCMMultiplierCache;
import org.bouncycastle.crypto.internal.modes.gcm.GCMUtil;
import org.bouncycastle.crypto.internal.modes.gcm.Tables1kGCMExponentiator;
    ...
    implements AEADBlockCipher
{
        ...
        throws IllegalArgumentException
    {
        ...
        if (keyParam != null)
        {
            ...
            multiplier = GCMMultiplierCache.fetch(H);
            exp = null;
        }
        else if (this.H == null)
        {
