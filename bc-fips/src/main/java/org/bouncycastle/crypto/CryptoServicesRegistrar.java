...
public final class CryptoServicesRegistrar
{
    ...
    static
    {
        ...
        localSetGlobalProperty(Property.DH_DEFAULT_PARAMS, toDH(def512Params, 160), toDH(def768Params, 160), toDH(def1024Params, 160), toDH(def2048Params, 224));
    }
    ...
    private static DHDomainParameters toDH(DSADomainParameters dsaParams, int L)
    {
