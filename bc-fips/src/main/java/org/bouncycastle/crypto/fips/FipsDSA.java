...
public final class FipsDSA
{
    ...
    static
    {
        ...
        // FSM_STATE:5.DSA.0,"DSA SIGN VERIFY KAT","The module is performing ECDSA sign and verify KAT self-test"
        // FSM_TRANS:5.DSA.0.0,"CONDITIONAL TEST","DSA SIGN VERIFY KAT","Invoke DSA Sign/Verify KAT self-test"
        provider.createEngine();
        // FSM_TRANS:5.DSA.0.1,"DSA SIGN VERIFY KAT","CONDITIONAL TEST","DSA Sign/Verify KAT self-test successful completion"
        // FSM_TRANS:5.DSA.0.1,"DSA SIGN VERIFY KAT","SOFT ERROR","DSA Sign/Verify KAT self-test failure"
        ...
        extends FipsAsymmetricKeyPairGenerator<KeyGenParameters, AsymmetricDSAPublicKey, AsymmetricDSAPrivateKey>
    {
        ...
        public AsymmetricKeyPair<AsymmetricDSAPublicKey, AsymmetricDSAPrivateKey> generateKeyPair()
        {
            ...
            // FSM_STATE:5.DSA.1,"DSA PAIRWISE CONSISTENCY TEST","The module is performing DSA Pairwise Consistency self-test"
            // FSM_TRANS:5.DSA.1.0,"CONDITIONAL TEST","DSA PAIRWISE CONSISTENCY TEST","Invoke DSA Pairwise Consistency test"
            validateKeyPair(kp);
            // FSM_TRANS:5.DSA.1.1,"DSA PAIRWISE CONSISTENCY TEST","CONDITIONAL TEST","DSA Pairwise Consistency test successful"
            // FSM_TRANS:5.DSA.1.2,"DSA PAIRWISE CONSISTENCY TEST","SOFT ERROR","DSA Pairwise Consistency test failed"
