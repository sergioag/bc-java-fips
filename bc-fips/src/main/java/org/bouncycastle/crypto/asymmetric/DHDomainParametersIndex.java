...
public class DHDomainParametersIndex
{
     ...
     */
    private static final DHDomainParameters ffdhe2048 =
    ...
    private static final DHDomainParameters ffdhe3072 =
        new DHDomainParameters(BigIntegers.fromUnsignedByteArray(Hex.decode(
            "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1\n" +
                "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9\n" +
                "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561\n" +
    ...
    private static final DHDomainParameters ffdhe4096 =
        new DHDomainParameters(BigIntegers.fromUnsignedByteArray(Hex.decode(
            "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1\n" +
                "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9\n" +
                "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561\n" +
    ...
    private static final DHDomainParameters ffdhe6144 =
        new DHDomainParameters(BigIntegers.fromUnsignedByteArray(Hex.decode(
            "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1\n" +
                "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9\n" +
                "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561\n" +
    ...
    private static final DHDomainParameters ffdhe8192 =
        new DHDomainParameters(BigIntegers.fromUnsignedByteArray(Hex.decode(
            "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1\n" +
                "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9\n" +
                "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561\n" +
     ...
     */
    private static final BigInteger modp2048p = BigIntegers.fromUnsignedByteArray(
            Hex.decode(
    ...
    private static final BigInteger modp3072p = BigIntegers.fromUnsignedByteArray(
                Hex.decode(
                    "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1\n" +
                        "29024E088A67CC74020BBEA63B139B22514A08798E3404DD\n" +
                        "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245\n" +
    ...
    public static final BigInteger modp4096p = BigIntegers.fromUnsignedByteArray(
        Hex.decode(
            "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1\n" +
                "29024E088A67CC74020BBEA63B139B22514A08798E3404DD\n" +
                "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245\n" +
    ...
    public static final BigInteger modp6144p = BigIntegers.fromUnsignedByteArray(
        Hex.decode(
    ...
    private static final BigInteger modp8192p = BigIntegers.fromUnsignedByteArray(
            Hex.decode(
                "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1\n" +
                    "29024E088A67CC74020BBEA63B139B22514A08798E3404DD\n" +
                    "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245\n" +
