    ...
    extends SecureRandom
{
        ...
        extends Source
    {
        ...
        public Data(int bitLength, byte[] data)
        {
        ...
        extends Source
    {
        ...
        {
            this(((hexData.length() & 1) == 1) ? Hex.decode("0" + hexData) : Hex.decode(hexData));
        }

        public BigInteger(int bitLength, String hexData)
        {
            super(expandToBitLength(bitLength, ((hexData.length() & 1) == 1) ? Hex.decode("0" + hexData) : Hex.decode(hexData)));
        }
    }
