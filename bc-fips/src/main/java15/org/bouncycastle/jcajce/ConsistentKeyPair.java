...
public class ConsistentKeyPair
{
    ...
    private void checkKeyPairForConsistency(PublicKey publicKey, PrivateKey privateKey)
    {
        ...
        else if (publicKey instanceof EdECKey && privateKey instanceof EdECKey)
        {
        ...
        else if (publicKey instanceof XECKey && privateKey instanceof XECKey)
        {
            if (!privateKey.getAlgorithm().equals(publicKey.getAlgorithm()))
            {
            ...
            try
            {
                ...
                if (publicData != null)
                {
                    ...
                    if (!Arrays.areEqual(publicData, keyInfo.getPublicKeyData().getBytes()))
                    {
        ...
        else if (publicKey instanceof LMSKey && privateKey instanceof LMSKey)
        {
            ...
            if (!Arrays.areEqual(priv.getPublicKey().getEncoded(), pub.getEncoded()))
            {
