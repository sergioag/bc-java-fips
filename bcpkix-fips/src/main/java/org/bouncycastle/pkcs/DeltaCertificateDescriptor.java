    ...
    extends ASN1Object
{
    ...
    {
        return getInstance(Extensions.getExtensionParsedValue(extensions, new ASN1ObjectIdentifier("2.16.840.1.114027.80.6.1")));
    }
    ...
    private DeltaCertificateDescriptor(ASN1Sequence seq)
    {
        ...
        ASN1BitString signatureValue = DERBitString.getInstance(next);
        ...
        TBSCertificate tbsCertificate, Extensions tbsExtensions)
    {
        ...
        if (validity != null && validity.equals(new Validity(tbsCertificate.getStartDate(), tbsCertificate.getEndDate())))
        {
            validity = null;
        }
        ...
        if (extensions != null)
        {
            ...
            for (Enumeration extEn = tbsExtensions.oids(); extEn.hasMoreElements();)
            {
                ...
                if (new ASN1ObjectIdentifier("2.16.840.1.114027.80.6.1").equals(oid))
                {
                    continue;
                }
