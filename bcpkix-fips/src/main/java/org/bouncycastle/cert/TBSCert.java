    ...
    extends ASN1Object
{
    ...
    public static TBSCert getInstance(
    ...
    public static TBSCert getInstance(
        Object  obj)
    {
        if (obj instanceof TBSCert)
        {
            return (TBSCert)obj;
        }
        else if (obj != null)
        {
            return new TBSCert(ASN1Sequence.getInstance(obj));
        }
    ...
    public TBSCert(ASN1Integer version, ASN1Integer serialNumber, AlgorithmIdentifier signature,
    ...
    public ASN1Primitive toASN1Primitive()
    {
        ...
        v.add(signature);
        v.add(issuer);
        v.add(validity.toASN1Primitive());
        v.add(subject);
