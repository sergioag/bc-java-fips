...
public interface CMSObjectIdentifiers
{
    ...
    /** 1.3.6.1.5.5.7.6 */
    ASN1ObjectIdentifier id_alg = X509ObjectIdentifiers.id_pkix.branch("6");
     ...
     */
    ASN1ObjectIdentifier id_alg_cek_hkdf_sha256 = PKCSObjectIdentifiers.id_smime.branch("3").branch("31");
}
