    ...
    extends ASN1Object
{
    ...
    private final DERIA5String canonicalId;
    ...
    private EeEcaCertRequest(ASN1Sequence seq)
    {
        ...
        canonicalId = OEROptional.getInstance(seq.getObjectAt(4)).getObject(DERIA5String.class);
    ...
    public DERIA5String getCanonicalId()
    {
        return canonicalId;
    }
