    ...
    extends OutputStream
{
    ...
    static final int TAGGED              = 0x80; // decimal 128 - maybe should deprecate this.
    static final int CONTEXT_SPECIFIC    = 0x80; // decimal 128
...
//                bb.writeBit(tagClass & CONTEXT_SPECIFIC)
//                    .writeBit(tagClass & BERTags.APPLICATION);
            ...
            if (debugOutput != null)
            {
                ...
                {
                    ASN1TaggedObject taggedObject = (ASN1TaggedObject)item;
                    if (taggedObject.getObject() instanceof ASN1ApplicationSpecific)
                    {
        ...
        case IA5String:
        {
            DERIA5String iaf = DERIA5String.getInstance(encodable);
