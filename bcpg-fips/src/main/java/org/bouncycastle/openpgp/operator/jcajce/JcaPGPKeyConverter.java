    ...
    extends PGPKeyConverter
{
        ...
        throws PGPException
    {
        switch (algorithm)
        {
            ...
            case PublicKeyAlgorithmTags.ECDSA:
            {
                ...
                NamedECDomainParameters params = ECDomainParametersIndex.lookupDomainParameters(curveOid);
    ...
    {
        ASN1ObjectIdentifier curveOID = ecPub.getCurveOID();
        NamedECDomainParameters x9Params = JcaJcePGPUtil.getX9Parameters(curveOID);
        ...
        ECPublicKeySpec ecPubSpec = new ECPublicKeySpec(
            ...
            new ECDomainParameterSpec(x9Params));
